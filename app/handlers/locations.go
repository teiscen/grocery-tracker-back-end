...
func (h *LocationHandler) Register(mux *http.ServeMux) {
	mux.HandleFunc("/location", func(w http.ResponseWriter, r *http.Request) {
		switch r.Method {
		case http.MethodGet:	h.GetLocations(w, r)
		case http.MethodPost:	h.CreateLocation(w, r)
		case http.MethodDelete: h.DeleteLocations(w, r)
		default:
	...
	mux.HandleFunc("/location/", func(w http.ResponseWriter, r *http.Request) {
		...
		switch r.Method {
		case http.MethodGet: 	h.GetLocation(w, r)
		case http.MethodDelete: h.DeleteLocation(w, r)
		default:
			http.Error(w, "method not allowed", http.StatusMethodNotAllowed)
		}		
	})
